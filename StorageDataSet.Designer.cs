...
namespace InfoStore {
    ...
    public partial class StorageDataSet : global::System.Data.DataSet {
        ...
        public partial class storeDataTable : global::System.Data.TypedTableBase<storeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public storeRow AddstoreRow(string Name, string Email, string PhoneNumber, string Location) {
        ...
        public partial class storeRow : global::System.Data.DataRow {
            ...
            public string PhoneNumber {
                get {
                    try {
                        return ((string)(this[this.tablestore.PhoneNumberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'PhoneNumber\' in table \'store\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablestore.PhoneNumberColumn] = value;
                }
            }
            ...
            public bool IsPhoneNumberNull() {
                return this.IsNull(this.tablestore.PhoneNumberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetPhoneNumberNull() {
                this[this.tablestore.PhoneNumberColumn] = global::System.Convert.DBNull;
            }
...
namespace InfoStore.StorageDataSetTableAdapters {
    ...
    public partial class storeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[store] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)) AND ((@IsNull_Location = 1 AND [Location] IS NULL) OR ([Location] = @Original_Location)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[store] ([Name], [Email], [PhoneNumber], [Location]) VALUES (@N" +
                "ame, @Email, @PhoneNumber, @Location);\r\nSELECT Id, Name, Email, PhoneNumber, Loc" +
                "ation FROM store WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[store] SET [Name] = @Name, [Email] = @Email, [PhoneNumber] = @PhoneNumber, [Location] = @Location WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)) AND ((@IsNull_Location = 1 AND [Location] IS NULL) OR ([Location] = @Original_Location)));
SELECT Id, Name, Email, PhoneNumber, Location FROM store WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InfoStore.Properties.Settings.Default.StorageConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Email, PhoneNumber, Location FROM dbo.store";
        ...
        public virtual int Fill(StorageDataSet.storeDataTable dataTable) {
        ...
        public virtual StorageDataSet.storeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StorageDataSet.storeDataTable dataTable = new StorageDataSet.storeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StorageDataSet.storeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Email, string Original_PhoneNumber, string Original_Location) {
        ...
        public virtual int Insert(string Name, string Email, string PhoneNumber, string Location) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Email, string PhoneNumber, string Location, int Original_Id, string Original_Name, string Original_Email, string Original_PhoneNumber, string Original_Location, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, string PhoneNumber, string Location, int Original_Id, string Original_Name, string Original_Email, string Original_PhoneNumber, string Original_Location) {
            return this.Update(Name, Email, PhoneNumber, Location, Original_Id, Original_Name, Original_Email, Original_PhoneNumber, Original_Location, Original_Id);
        }
    }
